...
var _reactSerpPreview = _interopRequireDefault(require("react-serp-preview"));
...
function SeoPaneComponent(_ref) {
  ...
  var _useQuery = (0, _reactQuery.useQuery)(["seoReview", document._rev], /*#__PURE__*/_asyncToGenerator(function* () {
    if (!document._id) throw new Error('Document is not published');else if (!options.url) badOption('url');

    var _yield$Promise$all = yield Promise.all([(0, _asyncCall.default)(options.keywords, document), (0, _asyncCall.default)(options.synonyms, document), (0, _asyncCall.default)(options.url, document)]),
    ...
    if (keywords && keywords === options.keywords) keywords = (0, _dlv.default)(document, keywords);
    if (synonyms && synonyms === options.synonyms) synonyms = (0, _dlv.default)(document, synonyms); // Tack on keywords and synonyms to seo review response since we use them.
  ...
  return /*#__PURE__*/_react.default.createElement(_ui.Box, {
    ...
    border: true,
    padding: 3
  }, /*#__PURE__*/_react.default.createElement(_reactSerpPreview.default, {
