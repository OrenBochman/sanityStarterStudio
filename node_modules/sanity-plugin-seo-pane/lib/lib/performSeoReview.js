...
function _performSeoReview() {
  _performSeoReview = _asyncToGenerator(function* (url, keyword, synonyms) {
    ...
    return fetch(previewUrl.toString(), {
      ...
      var permalink = (resPreviewUrl === null || resPreviewUrl === void 0 ? void 0 : resPreviewUrl.origin) + (resPreviewUrl === null || resPreviewUrl === void 0 ? void 0 : resPreviewUrl.pathname); // Confusingly, this key is just the pathname
